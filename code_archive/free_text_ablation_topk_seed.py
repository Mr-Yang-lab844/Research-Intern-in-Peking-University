...
# -*- coding: utf-8 -*-
"""
自由文本层16消融：固定特征数=11，遍历检索数量(1-7)和随机种子(42,123,2024)
输出AUC表格
"""
...
ALL_TEST_FILE = "./data/free_text_test.jsonl"   # 原始全部数据（98条），我们将用于抽样
EMBED_MODEL_NAME = "BAAI/bge-base-zh-v1.5"
SAE_TOP_K = 32
DEVICE = "cuda"
LAYER = 16
TOTAL_SAMPLES = 98        # 总样本数
DEV_SIZE = 49             # 开发集大小（一半）
TOP_FEATURES = 11         # 固定使用11个特征

# 待测试参数
TOP_K_LIST = list(range(1, 8))   # 1..7
