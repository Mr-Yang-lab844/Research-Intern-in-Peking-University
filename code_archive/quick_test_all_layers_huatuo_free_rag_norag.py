...
# -*- coding: utf-8 -*-
"""
HuatuoGPT-o1 自由文本全层扫描（无 RAG + 有 RAG）
...
def get_enhanced_index():
    index_path = "./faiss_free_enhanced_huatuo"
...
# ================= 运行两个实验 =================
# 无 RAG
results_no_rag = full_layer_scan(get_feature_no_rag, "HuatuoGPT-o1 无 RAG 全层扫描")

# 有 RAG
results_rag = full_layer_scan(get_feature_rag, "HuatuoGPT-o1 有 RAG 全层扫描 (Top-K=3)")