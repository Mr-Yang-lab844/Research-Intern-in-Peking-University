...
# -*- coding: utf-8 -*-
"""
RAG + SAE (Layer 20) with full training knowledge base (52741 items)
and fixed random test sampling (seed=42, 100 samples).
"""
...
# 保存风险分数
np.save("risk_scores_full_knowledge.npy", np.array(risk_scores))