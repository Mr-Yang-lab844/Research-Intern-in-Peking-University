...
# -*- coding: utf-8 -*-
"""
原始 Llama-3.1-8B-Instruct 选择题层24消融实验：固定特征数=3，改变检索数量(1-10)和随机种子(42,123,2024)
样本总量：200条（开发100，测试100）
...
TEST_SIZE = 100
FEATURE_COUNT = 3
TOP_K_LIST = list(range(1, 11))   # 检索数量1~10
...
print("\n=== 消融实验汇总 (原始 Llama, 层24, 特征数=3, 样本量=200) ===")
