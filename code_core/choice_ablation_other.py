...
# -*- coding: utf-8 -*-
"""
原始 Llama-3.1-8B-Instruct 选择题层22消融实验：固定特征数=10，改变检索数量(1-10)和随机种子(42,123,2024)
样本总量翻倍：200条（开发100，测试100）
模型：Llama-3.1-8B-Instruct，知识库：教科书+参考范围（不含同源训练集）
"""
...
FEATURE_COUNT = 10             # 固定特征数
TOP_K_LIST = list(range(9, 11))   # 默认1~10，可以根据实际实验调整数值
SEED_LIST = [42, 123, 2024]

# 缓存目录
CACHE_DIR = "./cache/choice_llama_layer22"
...
print("\n=== 消融实验汇总 (原始 Llama, 层22, 特征数=10, 样本量=200) ===")
