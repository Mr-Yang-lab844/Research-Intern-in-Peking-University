...
# -*- coding: utf-8 -*-
"""
HuatuoGPT-o1 自由文本无 RAG 全层扫描（0-31层）
- 直接使用 prompt "检验报告：{report}\n\n解读："
- 提取最后一个 token 的隐藏状态，经 SAE 编码
- 开发集上计算 t-statistic，选择 Top-10 特征
- 测试集上计算 AUC
"""
...
print("\n=== HuatuoGPT-o1 自由文本无 RAG 全层扫描 AUC 汇总 ===")
