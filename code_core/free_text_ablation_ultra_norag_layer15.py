...
# -*- coding: utf-8 -*-
"""
UltraMedical 自由文本无 RAG 特征数量消融（层15）
- 自然语言 prompt: "在某一次体检中，我的{report}，正常吗？"
- 固定划分：直接使用 free_text_dev.jsonl 和 free_text_test.jsonl
- 特征数量 1-30，输出 AUC 及 L1 基线
"""
...
CACHE_DIR = "./cache_ultra_free_norag_layer15"
